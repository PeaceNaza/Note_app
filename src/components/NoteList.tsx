...
const NoteList = ({ availableTags, notes, onDeleteTag, onUpdateTag  }: NoteListProps) => {
  ...
  const filteredNotes = useMemo(() => {
    return notes.filter((note) => {
      ...
      ); //searching to know if all tags selected matches the tags of the notes
    });
  ...
  return (
    <>
      ...
      <EditTagsModal onDeleteTag={onDeleteTag} onUpdateTag={onUpdateTag} show={editTagsModalShow} handleClose={() => setEditTagsModalShow(false)} availableTags={availableTags} />
    </>
  );
};
